import {BoardUtilsButtonsLayout, WritePostButton, BoardTitle, BoardListLayout, TableSchemaElement, TableTitleSchema, BoardTableSchema, BoardLayout} from'./BoardStyles';
...
const Board = () => {
    ...
    const setBoardListFromServer = () => {
        axios.get(`http://api.gwabang.site:8001/board/${majorId}/${boardId}/list`, {
            headers: {
    ...
    return(
        <>
            <BoardLayout>
                <BoardTitle>{majorName}-{boardName}</BoardTitle>
