...
export const PasswordChangeModal = ({setModalOpen}) => {
    ...
    const checkPasswordExp = (password) => {
                    ...
                    <ModalLayout>
                        ...
                        <ModalInputLayout>
                            ...
                            : <>
                                ...
                                <TextField type={"password"} size={"small"} color={"gray"} placeholder={"신규 비밀번호"} value={newPassword} onChange={(e)=>{setNewPassword(e.target.value)}}></TextField>
                                {checkPasswordExp(newPassword) ? <></> : <ModalWarningText>특수문자, 숫자, 영어를 포함 8자 이상 작성해주세요.</ModalWarningText>}
    
                                <ModalText>비밀번호 확인</ModalText>
                                <TextField type={"password"} size={"small"} color={"gray"} placeholder={"신규 비밀번호"} value={newPasswordCheck} onChange={(e)=>{setnewPasswordCheck(e.target.value)}}></TextField>
